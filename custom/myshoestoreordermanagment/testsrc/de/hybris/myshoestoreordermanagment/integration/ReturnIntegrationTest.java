...
public class ReturnIntegrationTest extends BaseAcceleratorSourcingIntegrationTest
{
			...
			throws RetryLaterException, InterruptedException, ImpExException
	{
		...
		importCsv("/myshoestoreordermanagment/test/impex/email-content.impex", WarehousingTestConstants.ENCODING);
		importCsv("/myshoestoreordermanagment/test/impex/email-content_en.impex", WarehousingTestConstants.ENCODING);
