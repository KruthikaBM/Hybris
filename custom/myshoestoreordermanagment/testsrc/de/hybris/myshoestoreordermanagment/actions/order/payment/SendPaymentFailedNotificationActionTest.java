 ...
 *
 */
package de.hybris.myshoestoreordermanagment.actions.order.payment;
...
import de.hybris.myshoestoreordermanagment.actions.order.payment.SendPaymentFailedNotificationAction;
...
public class SendPaymentFailedNotificationActionTest
{
	...
	/**
	 * Test method for
	 * {@link de.hybris.myshoestoreordermanagment.actions.order.SendPaymentFailedNotificationAction#executeAction(OrderProcessModel)}
	 * .
	 */
	@Test
