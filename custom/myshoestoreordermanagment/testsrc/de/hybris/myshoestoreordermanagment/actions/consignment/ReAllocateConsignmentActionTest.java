...
public class ReAllocateConsignmentActionTest
{
	...
	public void setup()
	{
		...
		when(orderBusinessProcessService
				.createProcess(anyString(), eq(MyshoestoreordermanagmentConstants.CONSIGNMENT_SUBPROCESS_NAME)))
		...
		doNothing().when(orderBusinessProcessService)
				.triggerChoiceEvent(orderModel, MyshoestoreordermanagmentConstants.ORDER_ACTION_EVENT_NAME,
