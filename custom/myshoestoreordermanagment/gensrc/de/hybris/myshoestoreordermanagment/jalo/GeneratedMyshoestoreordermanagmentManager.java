 ...
 * --- Generated at 30-Mar-2023, 3:41:44 PM                     ---
 * ----------------------------------------------------------------
 *  
...
/**
 * Generated class for type <code>MyshoestoreordermanagmentManager</code>.
 */
@SuppressWarnings({"deprecation","unused","cast"})
public abstract class GeneratedMyshoestoreordermanagmentManager extends Extension
{
	...
	{
		return (Boolean)item.getProperty( ctx, MyshoestoreordermanagmentConstants.Attributes.ConsignmentProcess.DONE);
	}
	...
	{
		item.setProperty(ctx, MyshoestoreordermanagmentConstants.Attributes.ConsignmentProcess.DONE,value);
	}
	...
	{
		return MyshoestoreordermanagmentConstants.EXTENSIONNAME;
	}
	...
	{
		return (Boolean)item.getProperty( ctx, MyshoestoreordermanagmentConstants.Attributes.ConsignmentProcess.WAITINGFORCONSIGNMENT);
	}
	...
	{
		item.setProperty(ctx, MyshoestoreordermanagmentConstants.Attributes.ConsignmentProcess.WAITINGFORCONSIGNMENT,value);
	}
	...
	{
		return (EnumerationValue)item.getProperty( ctx, MyshoestoreordermanagmentConstants.Attributes.ConsignmentProcess.WAREHOUSECONSIGNMENTSTATE);
	}
	...
	{
		item.setProperty(ctx, MyshoestoreordermanagmentConstants.Attributes.ConsignmentProcess.WAREHOUSECONSIGNMENTSTATE,value);
	}
