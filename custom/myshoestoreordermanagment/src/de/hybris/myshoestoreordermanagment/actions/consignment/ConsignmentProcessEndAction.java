 ...
 *
 */
package de.hybris.myshoestoreordermanagment.actions.consignment;
...
public class ConsignmentProcessEndAction extends AbstractProceduralAction<ConsignmentProcessModel>
{
	...
	public void executeAction(final ConsignmentProcessModel process)
	{
		...
		final String eventId =
				process.getParentProcess().getCode() + "_" + MyshoestoreordermanagmentConstants.ORDER_ACTION_EVENT_NAME;
		...
		LOG.debug("Process: {} fired event {}", process.getCode(), MyshoestoreordermanagmentConstants.ORDER_ACTION_EVENT_NAME);
	}
}
