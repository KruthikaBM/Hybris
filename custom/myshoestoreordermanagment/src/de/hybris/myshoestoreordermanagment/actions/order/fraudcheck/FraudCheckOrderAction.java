 ...
 *
 */
package de.hybris.myshoestoreordermanagment.actions.order.fraudcheck;
...
public class FraudCheckOrderAction extends AbstractFraudCheckAction<OrderProcessModel>
{
	...
	{
		final String value = Config.getParameter(MyshoestoreordermanagmentConstants.EXTENSIONNAME + ".fraud." + property);
