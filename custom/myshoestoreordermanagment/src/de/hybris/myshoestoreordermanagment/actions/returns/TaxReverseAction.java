...
package de.hybris.myshoestoreordermanagment.actions.returns;
...
public class TaxReverseAction extends AbstractSimpleDecisionAction<ReturnProcessModel>
{
	...
	public static final String TAX_REVERSE_FORCE_FAILURE = "myshoestoreordermanagment.reverse.tax.force.failure";
