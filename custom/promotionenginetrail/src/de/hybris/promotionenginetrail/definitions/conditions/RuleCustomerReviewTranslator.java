...
public class RuleCustomerReviewTranslator implements
        RuleConditionTranslator
{
    ...
    public static final String
            CUSTOMER_REVIEW_RAO_PRODUCT_ATTRIBUTE = "productCode";
    public static final String
            USER_RAO_CUSTOMER_REVIEWS_ATTRIBUTE = "customerReviews";
    public static final String USER_RAO_ID_ATTRIBUTE = "id";
    @Override
    public RuleIrCondition translate(final RuleCompilerContext context, final
            ...
            throws RuleCompilerException
    {
        final String orderEntryRaoVariable =
                context.generateVariable(OrderEntryRAO.class);
        final String cartRaoVariable = context.generateVariable(CartRAO.class);
        final String customerReviewRaoVariable =
                context.generateVariable(CustomerReviewRAO.class);
        final String userRaoVariable = context.generateVariable(UserRAO.class);
        final List<RuleIrCondition> irConditions = new ArrayList<>();
        final RuleIrAttributeRelCondition irCartOrderEntryRel = new
        ...
        final RuleIrTypeCondition irCustomerReviewProductRel = new
                RuleIrTypeCondition();
        irCustomerReviewProductRel.setVariable(customerReviewRaoVariable);
        final RuleIrAttributeRelCondition irOrderEntryProductRel = new
                RuleIrAttributeRelCondition();
        ...
        final RuleIrAttributeRelCondition irUserCustomerReviewRel = new
                RuleIrAttributeRelCondition();
        ...
        final RuleIrAttributeRelCondition irCartUserRel = new
                RuleIrAttributeRelCondition();
        ...
        final RuleIrAttributeCondition irExcludedCustomersCondition = new
