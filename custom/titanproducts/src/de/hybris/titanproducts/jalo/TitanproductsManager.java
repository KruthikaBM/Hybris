 ...
 */
package de.hybris.titanproducts.jalo;
...
import de.hybris.titanproducts.constants.TitanproductsConstants;
 ...
 */
public class TitanproductsManager extends GeneratedTitanproductsManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(TitanproductsManager.class.getName());
	 ...
	 */
	public static TitanproductsManager getInstance()
	{
		return (TitanproductsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(TitanproductsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TitanproductsManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TitanproductsManager called.");
		}
	}
