 ...
 */
package de.hybris.myshoestore.storefront.controllers;
	...
	interface Views
	{
		...
		interface Pages
		{
			...
			interface MultiStepCheckout // NOSONAR
			{
				...
				String LoyaltyPointsPage = "pages/checkout/multi/loyaltypointsPage"; // NOSONAR
			...
			interface Product // NOSONAR
			{
				...
				String newProductsDetails =  "pages/product/newProductsDetails";

				String create_products = "pages/product/create_products";
				String update_description = "pages/product/update_description";
			}
